  ...
  return (
    ...
    >
      <Svg width={size} height={size} viewBox="0 0 300 300">
        ...
        <Circle cx="45" cy="65" r="5" fill="#FBBF24" opacity="0.8" />
        <Circle cx="60" cy="85" r="3" fill="#FCD34D" opacity="0.7" />
        <Circle cx="50" cy="205" r="4.5" fill="#A5B4FC" opacity="0.75" />
        ...
        {/* Left Ear */}
        <Circle cx="82" cy="140" r="28" fill="#8D5B4C" />
        <Circle cx="84" cy="140" r="17" fill="#FED7AA" />

        {/* Right Ear */}
        <Circle cx="218" cy="136" r="28" fill="#8D5B4C" />
        <Circle cx="216" cy="136" r="17" fill="#FED7AA" />
        ...
        <Circle cx="180" cy="212" r="11" fill="#FED7AA" stroke="#8D5B4C" strokeWidth="2.5" />
        ...
        <G transform="rotate(-4 150 140)">
          ...
          <G>
            {/* Left Eye */}
            <Ellipse cx="124" cy="130" rx="14" ry="19" fill="#0F172A" />
            <Circle cx="122" cy="123" r="6" fill="#FFFFFF" />
            <Circle cx="128" cy="136" r="3" fill="#FFFFFF" />

            {/* Right Eye */}
            <Ellipse cx="176" cy="130" rx="14" ry="19" fill="#0F172A" />
            <Circle cx="174" cy="123" r="6" fill="#FFFFFF" />
            <Circle cx="180" cy="136" r="3" fill="#FFFFFF" />
          </G>
          ...
          <Circle cx="134" cy="167" r="11" fill="#FED7AA" stroke="#8D5B4C" strokeWidth="2.5" />
          ...
          <G transform="rotate(-5 150 78)">
            ...
            <Path
              ...
              strokeLinecap="round"
            />
            <Circle cx="180" cy="98" r="4" fill="#F59E0B" />
            <Rect x="178" y="100" width="5" height="9" rx="2" fill="#F59E0B" />
          </G>
        </G>

        {/* THOUGHT BUBBLES & GLOWING QUESTION MARK (Pondering / Guessing) */}
        {/* Smallest Bubble */}
        <Circle cx="212" cy="94" r="5.5" fill="#C7D2FE" opacity="0.9" />

        {/* Medium Bubble */}
        <Circle cx="228" cy="76" r="8.5" fill="#A5B4FC" opacity="0.95" />
        ...
        <G transform="translate(195, 12)">
          ...
          <Path
            ...
            strokeLinecap="round"
          />
          <Circle cx="59.2" cy="45" r="2.2" fill="#4F46E5" />
        </G>
      </Svg>
    </Animated.View>
  );
